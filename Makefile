...
define Package/freeradius2-mod-python3
  $(call Package/freeradius2/Default)
  DEPENDS:=freeradius2 +python3
  TITLE:=Python3 module
endef

define Package/freeradius2-mod-python3/conffiles
/etc/freeradius2/mods-available/python3
endef
...
define Package/freeradius2-mod-sql-null
  $(call Package/freeradius2/Default)
